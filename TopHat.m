I = imread('C:\Users\G4G4N\Desktop\MATLAB_PROJECT\licenseplatesegment\TestImageMorphological\d1.jpg');
...
while i <= x 
    ...
    if ((j == i+100) && (flg == 0))
        ...
        figure
        imshow(H(i:j,:));
        imwrite(H(i:j,:),'tophat.jpg','jpg');
        i = i + 50;
    end
    i = i + 1;
end

img = imread('C:\Users\G4G4N\Desktop\MATLAB_PROJECT\licenseplatesegment\tophat.jpg');
